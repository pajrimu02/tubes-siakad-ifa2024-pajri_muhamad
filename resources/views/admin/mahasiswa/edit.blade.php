...
<div class="page-wrapper">
    ...
    <div class="page-header">
        <div class="header-left">
            <a href="{{ route('mahasiswa.show', $mahasiswa->id) }}" class="btn-back">
            ...
            <div class="header-title">
                ...
                <p>Perbarui data <strong>{{ $mahasiswa->nama }}</strong> &mdash; NIM {{ $mahasiswa->nim }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="info-banner">
            ...
            <span>
                Email login akan ikut diperbarui sesuai NIM baru &mdash;
                Akun saat ini: <strong>{{ $mahasiswa->user?->email ?? '-' }}</strong>
            </span>
        </div>
        ...
        <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST">
            ...
            <div class="form-actions">
                <a href="{{ route('mahasiswa.show', $mahasiswa->id) }}" class="btn btn-secondary">Batal</a>
